                            ...
                            <div class="col-7"> 
                                ...
                                <form action="<%= request.getContextPath()%>/ProductController" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="productDescription" required placeholder="Product Description" class="form-control" >

                                    </div>
                                    <div class="mb-3">
                                        <label for="productPrice" class="form-label">Price</label>
                                        <input type="number" name="productPrice" required placeholder="Product Price" class="form-control" >
                                    </div>
                                    <div class="row">
                                        <div class="col-3">


                                            <select class="form-select form-select-sm" name="productType" aria-label="Default select example">
                                             
                                                <c:forEach items="${category}" var="list"> 
                                                
                                                <option value="${list.getCategory_id()}">${list.getCategory_name()}</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7" id="imageLink"> 
                                                ...
                                                <input name="productImage"  id="image-final" hidden  class="form-control"   type="text"/>
                                        ...
                                        <img  id="image-preview" width="250" height="200" alt="product"/>
                                    </div>
                                    ...
                                    <a class="btn btn-secondary" href="<%= request.getContextPath()%>/ProductController"> Back </a>
                                </form>
