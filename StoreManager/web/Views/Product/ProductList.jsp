                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid" id="listCustomer" style="display: block"  >
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <a class="btn btn-success" href="<%= request.getContextPath()%>/addProductController">Thêm Sản Phẩm</a>
                                    </div>

                                    <div class="col-9">
                                        <form action="<%= request.getContextPath()%>/ProductList" method="post"> 
                                            <div class="row"> 

                                                <div class="col-7"> 
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1">Tìm Sản Phẩm</span>
                                                        <input type="text" class="form-control" name="searchString"  aria-describedby="basic-addon1">
                                                    </div>
                                                </div> 
                                                <div class="col-3"> 
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${ProductList}" var="list" >
                                            ...
                                            <tr>
                                                ...
                                                <c:if test="${list.getProduct_type()==1}">
                                                     <td>Wedding Cake</td>
                                                </c:if>
                                                     <c:if test="${list.getProduct_type()==2}">
                                                     <td>Birthday Cake</td>
                                                </c:if>
                                                     <c:if test="${list.getProduct_type()==3}">
                                                     <td>Custom Cake</td>
                                                </c:if>
                                                ...
                                                <td>
                                                    <img src="${list.getProduct_img()}" width="200px" height="150px" alt="product"/>
                                                   
                                                </td>

                                                <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.getPrice()}" /> VNĐ</td>
                                                <td><a href="<%= request.getContextPath()%>/EditProductController?productId=${list.getProduct_id()}">Xem Chi Tiết</a></td>
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPage <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="ProductList?myBTN=${currentPage - 1}"  value="${currentPage - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    ...
                                    <a  name="myBTN" class="page-link" href="ProductList?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPage ==pageNumber}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="ProductList?myBTN=${currentPage + 1}" value="${currentPage + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
