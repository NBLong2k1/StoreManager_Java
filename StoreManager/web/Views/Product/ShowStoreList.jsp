                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid" id="listCustomer" style="display: block"  >
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <a class="btn btn-success" href="<%= request.getContextPath()%>/Views/Product/AddStore.jsp">ThêmCửa Hàng</a>
                                    </div>
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-7"> 
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1">Tìm Cửa Hàng</span>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listStore}" var="list" >
                                            ...
                                            <tr>
                                                ...
                                                <td>${list.getStore_name()}</td>

                                                <td>${list.getStore_address()}</td>

                                                <td>${list.getCity()}</td>

                                                <td>${list.getPhone()}</td>
                                                <td><a href="<%= request.getContextPath()%>/EditStoreController?storeId=${list.getStore_id()}">Xem Chi Tiết</a></td>
