                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid" id="EmployeeInsert" style="display: block" >
                            ...
                            <form action="<%= request.getContextPath()%>/CustomerprocessOrderDetailsController" method="post"> 
                                                ...
                                                <tbody>
                                                  ...
                                                  <%count++;%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.getTotal()}" /> VNĐ</td>
                            ...
                            <a href="<%= request.getContextPath()%>/successCustomerOrderController" class="btn btn-secondary">Trở Lại</a>
