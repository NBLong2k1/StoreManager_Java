                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid" id="EmployeeInsert" style="display: block" >
                            ...
                            <form action="<%= request.getContextPath()%>/processOrderDetailsController" method="post"> 
                             <button type="submit" name="acceptOrder" class="btn btn-success">Duyệt Đơn</button>
                 
                              <button type="submit" name="confirmOrder" class="btn btn-primary">Xác Nhận Thành Công</button>
                              <button type="submit" name="failOrder" class="btn btn-danger">Xác Nhận Thất Bại</button>
                                                ...
                                                <tbody>
                                                  ...
                                                  <%count++;%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.getAmount_price()}" /> VNĐ</td>
                                                            <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.getAmount_price() * list.getQuantity()}" /> VNĐ</td>
                                                           <input type="text" name="orderID" hidden value="${list.getOrder_id()}"/>
                                                        </tr>
                                                    </c:forEach>
                            ...
                            <a href="<%= request.getContextPath()%>/orderController" class="btn btn-secondary">Trở Lại</a>
