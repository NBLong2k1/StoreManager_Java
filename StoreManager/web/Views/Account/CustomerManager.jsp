            ...
            <div id="content">
             ...
             <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div  >
                        <a href="<%= request.getContextPath()%>/ProductPageController" class="btn btn-primary"><i class="fa fa-plus"></i> Mua Thêm</a>
                   </div>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <c:if test="${list.getOrder_status()==2}"> 
                                                    <a href="#" class="btn btn-success" readonly>Đã Giao</a>
                                                </c:if>
                                                      <c:if test="${list.getOrder_status()==3}"> 
                                                    <a href="#" class="btn btn-danger" readonly>Thất Bại</a>
                                                </c:if>
                                            </td>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <a href="<%= request.getContextPath()%>/ShowCustomerCart?customerUser=${username}" class="btn btn-success">Xác Nhận</a>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.getPrice()}" /> VNĐ</td>
                                           </tr> 
                                             </c:forEach>
                                        </tbody>
                                      </table>
