        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!--  Employee    -->
                    <div class="container-fluid" id="listEmployee" style="display: block"  >
                        ...
                        <div class="row">
                            <div class="col-3">
                                <a href="<%= request.getContextPath()%>/Views/Account/AddEmployee.jsp" class="btn btn-success" id="AddEmployee"><i class="fa fa-plus"></i> Thêm Nhân Viên</a>

                            </div>

                            <div class="col-9">
                                <form action="<%= request.getContextPath()%>/EmployeeList" method="post"> 
                                    <div class="row"> 
                                        <div class="col-7"> 
                                            <input type="text" name="searchEmployee" id="inputSearch" class="form-control" placeholder="Tìm Kiếm Nhân Viên">
                                        </div> 
                                        <div class="col-3"> 
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${empList}" var="list" >
                                    ...
                                    <tr>
                                        ...
                                        <td>${list.getEmail()}</td>
                                        <td>${list.getPhone()}</td>
                                        <td>${list.getStarted_date()}</td>
                                        <td><div class="form-check form-switch" >
                                                
                                                <input style="margin-left:   1px" readonly disabled class="form-check-input" type="checkbox" name="EmployeeStatus" role="switch" id="flexSwitchCheckChecked" 
                                            ...
                                            <td>
                                                <c:if test="${list.getRole()==0}">
                                                    Nhân Viên
                                                </c:if>
                                                 <c:if test="${list.getRole()==1}">
                                                   Quản Lý
                                                </c:if>
                                                 <c:if test="${list.getRole()==2}">
                                                    Shipper
                                                </c:if>
                                            
                                            </td>
                                             <c:if test="${role==1}">
                                      <td><a href="EditEmployeeController?EmpId=${list.getEmployee_id()}">Xem</a></td>
                                    </c:if>
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPage <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="EmployeeList?myBTN=${currentPage - 1}"  value="${currentPage - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    ...
                                    <a  name="myBTN" class="page-link" href="EmployeeList?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPage ==pageNumber}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="EmployeeList?myBTN=${currentPage + 1}" value="${currentPage + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
                <!-- End of Main Content -->
