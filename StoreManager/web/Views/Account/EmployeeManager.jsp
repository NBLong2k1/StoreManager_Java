                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                        Thu Nhập Hàng Ngày</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${SumearningDaily}" /> VNĐ</div>
                                                </div>
                                                <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                        Thu Nhập Khách Hàng (Ngày)</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${earningDailyCustomer}" /> VNĐ</div>
                                                </div>
                                                <div class="col-auto">
                                                    <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                                </div>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                        Thu Nhập Khách Guest (Ngày)</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${earningGuestDaily}" /> VNĐ</div>
                                                </div>
                                                <div class="col-auto">
                                                    <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card shadow mb-4">
                                        ...
                                        <!-- Card Body -->
                                        <div class="card-body" id="listProduct" style="display: block">
                                            
                                           
                                                 <h1 style='display:inline'>Danh Sách Đơn Hàng Chờ Guest</h1>  
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">#</th>
                                                   ...
                                                   <%int count=0;%>
                                                    <c:forEach items="${listprocessOrder}" var="list" > 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a  href="processOrderDetailsController?guest_id=${list.getOrder_id()}">Xem Chi Tiết</a></td>
                                                        </tr>
                                                    </c:forEach>
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPage <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="EmployeeController?myBTN=${currentPage - 1}"  value="${currentPage - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    ...
                                    <a  name="myBTN" class="page-link" href="EmployeeController?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPage ==pageNumber}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="EmployeeController?myBTN=${currentPage + 1}" value="${currentPage + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
                                </div>
