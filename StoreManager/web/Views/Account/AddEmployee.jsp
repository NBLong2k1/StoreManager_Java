                                ...
                                <div class="col-7"> 
                                    <form action="<%= request.getContextPath()%>/AdminController" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" name="EmployeeEmail" required placeholder="Nhập Email" id="exampleInputEmail1" aria-describedby="emailHelp">

                                        </div>
                                        <div class="mb-3">
                                            <label for="EmployeeName" class="form-label">Họ Và Tên</label>
                                            <input type="text" name="EmployeeName" required placeholder="Nhập Họ Và Tên" class="form-control" id="EmployeeName" aria-describedby="emailHelp">

                                        </div>
                                        <div class="mb-3">
                                            <label for="Usrname" class="form-label">Usrname</label>
                                            <input type="text" name="EmployeeUsrname" required placeholder="Nhập Username" class="form-control" id="Usrname">
                                        </div>

                                        <div class="mb-3">
                                            <label for="Password" class="form-label">Mật Khẩu</label>
                                            <input type="Password" name="EmployeePassword" required placeholder="Nhập Mật Khẩu" class="form-control" id="Password" aria-describedby="emailHelp">

                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="EmployeeRole" id="inlineRadio1" checked value="0">
                                            <label class="form-check-label" for="inlineRadio1">Nhân Viên</label>
                                        </div>
                                        <div class="form-check form-check-inline"style="margin-left: 15px" >
                                            <input class="form-check-input" type="radio" name="EmployeeRole" id="inlineRadio2" value="1">
                                            <label class="form-check-label" for="inlineRadio2">Quản Lý</label>
                                        </div>

                                        <div class="row">
                                            <div class="col-3">
                                                <label class="form-check-label" for="EmployeStoreId">Cửa Hàng</label>


                                                <select class="form-select form-select-sm" id="EmployeStoreId"  name="EmployeStoreId" aria-label="Default select example">
                                        ...
                                        <button type="submit" name="submitAddEmployee" class="btn btn-primary">Submit</button>
                                    </form>
