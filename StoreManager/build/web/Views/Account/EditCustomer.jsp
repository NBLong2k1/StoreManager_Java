            ...
            <div id="wrapper">
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid" id="updateCustomer" style="display: block" >
                                    ...
                                    <form action="<%= request.getContextPath()%>/CustomerController" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="customerName" class="form-label">Họ Và Tên</label>
                                                          <input type="text" name="customerID" value="${cus.getCustomer_id()}"  hidden class="form-control">

                                            <input type="text" name="customerName" readonly value="${cus.getCustomer_name()}" required placeholder="Nhập Họ Và Tên" class="form-control">

                                        </div>
                                        
                                             <div class="mb-3">
                                            <label for="customerEmail" class="form-label">Email</label>
                                            <input type="email" readonly readonly class="form-control" value="${cus.getEmail()}" name="customerEmail" required placeholder="Nhập Email">

                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="customerUsrname" class="form-label">Usrname</label>
                                            <input type="text"  readonly name="customerUsrname" value="${cus.getUsername()}" required placeholder="Nhập Username" class="form-control">
                                        </div>

                                        <div class="mb-3">
                                            <label for="Password" class="form-label">Mật Khẩu</label>
                                            <input readonly type="Password" name="customerPassword" value="${cus.getPassword()}" required placeholder="Nhập Mật Khẩu" class="form-control" id="Password" aria-describedby="emailHelp">

                                        </div>
                                        
                                         <div class="mb-3">
                                            <label for="Phone" class="form-label">Số Điện Thoại</label>
                                            <input readonly type="number" name="customerPhone" value="${cus.getPhone()}" required placeholder="Nhập Số Điện Thoại" class="form-control">
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="Dob" class="form-label">Ngày Sinh</label>
                                            <input type="date"readonly name="customerDob" value="${cus.getDob()}" required placeholder="Nhập Ngày Sinh" class="form-control">
                                        </div>
                                        ...
                                        <div hidden class="row">
                                             <div class="col-3">
                                                <div class="form-check form-switch">
                                                    <label class="form-check-label" for="flexSwitchCheckChecked">Trạng Thái Hoạt Động</label>
                                                    <input style="margin-left: 15px" class="form-check-input" type="checkbox" name="customerStatus" role="switch" id="flexSwitchCheckChecked" 
                                                           <c:if test="${cus.getStatus()==1}"> 
                                                           checked
                                                           </c:if>
                                                           >
                                                </div>
