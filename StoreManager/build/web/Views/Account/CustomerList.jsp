                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid" id="listCustomer" style="display: block"  >
                            ...
                            <div class="col-9">
                                <form action="<%= request.getContextPath()%>/ListCustomer" method="post"> 
                                    <div class="row"> 
                                        <div class="col-7"> 
                                            <input type="text" name="searchCustomer" id="inputSearch" class="form-control" placeholder="Tìm Kiếm Khách Hàng">
                                        </div> 
                                        <div class="col-3"> 
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">SÐT</th>
                                        <th hidden scope="col">Hoạt Động</th>
                           ...
                           %>
                                    ...
                                    <c:forEach items="${cusList}" var="list" >
                                        ...
                                        <tr>
                                            ...
                                            <td>${list.getEmail()}</td>
                                            <td>${list.getPhone()}</td>
                                                  <td hidden><div class="form-check form-switch" >
                                                
                                                <input style="margin-left:   1px" readonly class="form-check-input" type="checkbox" name="CustomerStatus" role="switch" id="flexSwitchCheckChecked" 
                                                       <c:if test="${list.getStatus()==1}"> 
                                                       checked
                                                       </c:if>>
                                                       
                                            </div></td>
                                            <td><a href="CustomerController?CusId=${list.getCustomer_id()}">Xem Chi Tiết</a></td>
...
<div>
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPageCustomer <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="ListCustomer?myBTN=${currentPageCustomer - 1}"  value="${currentPageCustomer - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    class="page-item <%if (Integer.parseInt(String.valueOf(session.getAttribute("currentPageCustomer"))) == i + 1) {%> active <%}%>">
                                    <a  name="myBTN" class="page-link" href="ListCustomer?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPageCustomer ==pageNumberCustomer}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="ListCustomer?myBTN=${currentPageCustomer + 1}" value="${currentPageCustomer + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
                    <!-- End of Main Content -->
