                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid" id="listCustomer" style="display: block"  >
                                ...
                                <h1 style='display:inline'>Danh Sách Đơn Hàng Guest Đã Xử Lý</h1>  
                                 <div class row>
                                    <div class="col-6"> 
                                        <form action="<%= request.getContextPath()%>/successOrderController" method="post"> 
                                            <div class="row"> 
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPage <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="successOrderController?myBTN=${currentPage - 1}"  value="${currentPage - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    ...
                                    <a  name="myBTN" class="page-link" href="successOrderController?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPage ==pageNumber}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="successOrderController?myBTN=${currentPage + 1}" value="${currentPage + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
