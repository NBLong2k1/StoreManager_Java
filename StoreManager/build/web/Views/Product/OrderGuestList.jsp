                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-7"> 
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Emai Hoặc ID Đơn Hàng" name="searchString"  aria-describedby="basic-addon1">
                                                    </div>
                                                </div> 
                                                <div class="col-3"> 
                                                   ...
                                                   <%int count=0;%>
                                                    <c:forEach items="${listprocessOrder}" var="list" > 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${list.getPhone()}</td>
                                                             <td>
                                                                 <c:if test="${list.getDelivery_way()==1}">
                                                                      <a readonly class="btn btn-primary">Giao Hàng</a>
                                                                 </c:if>
                                                                      
                                                                   <c:if test="${list.getDelivery_way()==0}">
                                                                      <a readonly class="btn btn-success">Lấy tại cửa hàng</a>
                                                                 </c:if>
                                                             </td>
                                                            <td>
                            ...
                            <ul class="pagination">
                                 <li
                                    class="page-item <c:if test="${currentPage <=1 }">  disabled</c:if>">
                                     <a class="page-link" name="myBTN" href="orderController?myBTN=${currentPage - 1}"  value="${currentPage - 1}">Previous</a></li>
                                        <%
                                ...
                                <li
                                    ...
                                    <a  name="myBTN" class="page-link" href="orderController?myBTN=<%=i + 1%>" value="<%=i + 1%>"><%=i + 1%></a></li>
                                        <%
                                        }
                                        %>
                                <li
                                    class="page-item <c:if test="${currentPage ==pageNumber}">  disabled</c:if>">
                                    <a class="page-link" name="myBTN" href="orderController?myBTN=${currentPage + 1}" value="${currentPage + 1}">Next</a></li>
                            </ul>
                        </nav>
                                </div>
