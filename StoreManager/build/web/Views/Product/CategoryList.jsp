                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid" id="listCustomer" style="display: block"  >
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <a class="btn btn-success" href="AddCategory.jsp">Thêm Loại Bánh</a>
                                    </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listCategory}" var="list" >
                                            ...
                                            <tr>
                                                ...
                                                <td>${list.getCategory_type()}</td>
                                                
                                                <td><a href="<%= request.getContextPath()%>/EditCategoryController?categoryId=${list.getCategory_id()}">Edit</a></td>
