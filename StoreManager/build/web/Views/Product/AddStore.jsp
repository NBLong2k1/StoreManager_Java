    ...
    <body id="page-top">
            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <!-- Sidebar - Brand -->
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<%= request.getContextPath()%>/EmployeeController">
                        ...
                        <div class="container-fluid" id="EmployeeInsert" style="display: block" >
                            ...
                            <div class="row">
                                <div class="col-7"> 
                                    ...
                                    <form action="<%= request.getContextPath()%>/StoreController" method="post">
                                        <div class="mb-3">
                                            <label for="StoreName" class="form-label">Tên Cửa Hàng</label>
                                            <input type="text" class="form-control" name="StoreName" required placeholder="Nhập Tên Cửa Hàng">

                                        </div>
                                        <div class="mb-3">
                                            <label for="productDescription" class="form-label">Địa Chỉ</label>
                                            <input type="text" name="StoreAddress" required placeholder="Nhập Địa Chỉ" class="form-control" >

                                        </div>
                                        <div class="mb-3">
                                            <label for="productPrice" class="form-label">Thành Phố</label>
                                            <input type="text" name="StoreCity" required placeholder="Nhập Thành Phố" class="form-control" >
                                        </div>

                                        <div class="mb-3">
                                            <label for="productImage" class="form-label">Số Điện Thoại</label>
                                            <input type="number" name="StorePhone" required placeholder="Nhập Số Điện Thoại" class="form-control" >

                                        </div>
                                       

                                        </br>
                                        <button type="submit" name="submitAddStore" class="btn btn-primary">Thêm Cửa Hàng</button>
                                        <a href="<%= request.getContextPath()%>/StoreController" class="btn btn-secondary"> Back</a>
                                    </form>
