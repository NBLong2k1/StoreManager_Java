                        ...
                        <div class="container-fluid" id="EmployeeInsert" style="display: block" >
                            ...
                            <div class="row">
                                <div class="col-7"> 
                                    ...
                                    <form action="<%= request.getContextPath()%>/EditCategoryController" method="post">
                                        <div class="mb-3">
                                            <label for="CategoryName" class="form-label">Category Name</label>
                                            <input type="text" class="form-control" value="${Category.getCategory_name()}" name="CategoryName" required placeholder="Enter Category Name">
<input type="text" class="form-control" value="${Category.getCategory_id()}" hidden name="CategoryID" >

                                            
                                        </div>
                                        <div class="mb-3">
                                            <label for="CategoryType" class="form-label">Category Type</label>
                                            <input type="number" class="form-control" readonly value="${Category.getCategory_type()}" name="CategoryType" required placeholder="Enter Category Type">
                                   ...
                                   <a hidden class="btn btn-danger" href="<%= request.getContextPath()%>/EditCategoryController?cateID=${Category.getCategory_id()}"> Delete </a>
